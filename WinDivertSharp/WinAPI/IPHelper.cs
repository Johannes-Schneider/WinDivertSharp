...
namespace WinDivertSharp.WinAPI
{
    public class IPHelper
    {
        ...
        /// </exception>
        public static List<TcpProcessRecord> GetAllTcpConnections(IPVersion ipVersion = IPVersion.IPv4)
        {
            int bufferSize = 0;
            ...
            uint result = GetExtendedTcpTable(IntPtr.Zero, ref bufferSize, true, (int)ipVersion,
            ...
            try
            {
                ...
                result = GetExtendedTcpTable(tcpTableRecordsPtr, ref bufferSize, true,
                    (int)ipVersion, TcpTableClass.TCP_TABLE_OWNER_PID_ALL);
        ...
        /// is insufficient memory to satisfy the request.
        /// </exception>
        private static List<UdpProcessRecord> GetAllUdpConnections(IPVersion ipVersion = IPVersion.IPv4)
        {
            int bufferSize = 0;
            ...
            uint result = GetExtendedUdpTable(IntPtr.Zero, ref bufferSize, true,
                (int)ipVersion, UdpTableClass.UDP_TABLE_OWNER_PID);
        ...
        // Enum to define the version of the internet protocol to use for further functions.
